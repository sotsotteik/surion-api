...
class clicaptcha{
	...
	public function creat(){
		...
		$imagePath = WEB.$imagePathArr[rand(0, count($imagePathArr) - 1)];;
		$fontPath = realpath('font/SourceHanSansCN-Normal.ttf');
	...
	private function randChars($length = 4){
		...
		if ($this->language == 'en') {
			$chars = 'ABCDEFGHIJKLMNOPGRSTUVWXYZabcdefghijklimnopqrstuvwxyz1234567890';
		} else {
